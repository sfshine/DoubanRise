...
public class ConfirmDeleteDnoteDialog extends DialogFragment implements
		View.OnClickListener {

	Context context;
	private TextView content_tv;
	private TextView title_tv;
	private String content = "确实要删除吗？";
	private String title = "注意！";

	public ConfirmDeleteDnoteDialog(String content_tv, String title) {
		super();
		this.content = content_tv;
		this.title = title;
	}

	public ConfirmDeleteDnoteDialog() {
		super();
	...
	public void onClick(View v) {
		...
		case R.id.common_dialog_btn_ok:
			((DNoteViewActivity) context).deleteNote();
			this.dismiss();
			break;
